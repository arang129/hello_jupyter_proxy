...
`sudo -E pip install git+https://github.com/arang129/hello_jupyter_proxy.git`

`sudo -E pip install --upgrade git+https://github.com/arang129/hello_jupyter_proxy.git`

`sudo -E pip uninstall hello_jupyter_proxy`
